...
st.title("🚀 Job Skill Profiler")
st.write("Instantly analyze any job description to identify the essential skills. Understand the core requirements of a role before you apply.")
